package com.mfq.home.schooljob.plugin;
...
//            fieldList.add(fieldSumId);
    ...
    private void generateToString(IntrospectedTable introspectedTable, TopLevelClass topLevelClass) {
        ...
        topLevelClass.addImportedType(new FullyQualifiedJavaType("com.mfq.home.schooljob.validator.annotation.Domain"));
            ...
            if (f != null) {
                ...
                if (column.getRemarks() != null) {
                    ...
                    if (column.getRemarks().indexOf("@BizId") != -1 || column.getRemarks().indexOf("BizId") != -1
                        ...
                        topLevelClass.addImportedType(new FullyQualifiedJavaType("com.mfq.home.schooljob.validator.annotation.BizId"));
                    }
